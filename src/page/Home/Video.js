...
import { faCommentDots, faHeart, faPlus, faShare } from '@fortawesome/free-solid-svg-icons';
...
function Video() {
    ...
    const handleUpdateProgress = () => {
        const curPercent = videoRef.current.currentTime / videoRef.current.duration;
            ...
            <div className={cx('video-item-wrapper')}>
                <div className={cx('main-content')}>
                    ...
                    >
                        ...
                        <div className={cx('video-container')}>
                            ...
                            <div className={cx('progress-bar')}>
                                ...
                                <div ref={progressRef} className={cx('current-percent')}></div>
                            </div>
                            {/* End */}
                        </div>
                    </div>
                    <div className={cx('action-bar')}>
                        ...
                        <InfoDialog>
                            <div className={cx('user-item')}>
                                ...
                                <span className={cx('check')}>
                                    ...
                                    <FontAwesomeIcon className={cx('check-icon')} icon={faPlus} />
                                </span>
                            </div>
                        </InfoDialog>
                        {/* add event here */}
                        ...
                        <div
                            className={cx('action-item', { active: isFavorite })}
