...
import { faEllipsis, faVolumeHigh, faVolumeXmark } from '@fortawesome/free-solid-svg-icons';
    ...
    return (
        <div className={cx('option', { visible })}>
            <span className={cx('volume')} onClick={handleVolume}>
                {isMuted ? (
                    <FontAwesomeIcon className={cx('option-icon')} icon={faVolumeXmark} />
                ) : (
                    <FontAwesomeIcon className={cx('option-icon')} icon={faVolumeHigh} />
                )}
            </span>
                    ...
                    render={() => (
                        <div className={cx('tippy-wrapper')}>
                            <div className={cx('btn-wrapper')}>
                                <Button text leftIcon={<AutoScrollIcon />} className={cx('btn')}>
                                    Auto scroll
                                </Button>
                                <div
                            ...
                            <div className={cx('btn-wrapper')}>
                                <Button text leftIcon={<HeartBrokenIcon />} className={cx('btn')}>
                                    Not interested
                                </Button>
                            </div>
                            <div className={cx('btn-wrapper')}>
                                <Button text leftIcon={<FlagIcon />} className={cx('btn')}>
                                    Report
                                </Button>
                            </div>
                        </div>
